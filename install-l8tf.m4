...
@%:@ options to be saved
  ...
  --specs='$l8_specs'
  --unit-sources='$l8_unit_sources'
  --unit-prefix='$l8_unit_prefix'
L8END]
...
l8_specs='@R/ssmoo'
l8_specs_in_root=:
l8_unit_sources=          # leave blank, resolve later
l8_unit_sources_in_root=  # leave blank, resolve later
l8_unit_prefix=uT-
...
check_rs_paths l8_unit_sources l8_specs

AS_VAR_IF([[l8_unit_prefix]],[],[[l8_fn_fatal "--unit-prefix cannot be blank"]])
...
m4@&t@_define([L8_PATH_UNIT_PREFIX],           [$l8_unit_prefix])d@&t@nl
m4@&t@_define([L8_PATH_UNIT_SOURCES],          [$l8_unit_sources_full])d@&t@nl
L8END
...
# configure, main_suite, unit_suite, t0
#
